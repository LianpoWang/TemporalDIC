...
class TemporalDICNet(nn.Module):
    """
    Temporal-DICnet: A deep learning network for deformation field estimation
    
    The network takes 4 consecutive deformed images (It-1, It, It+1, It+2) and 
    one reference image (I0) as input to predict deformation fields.
    """
